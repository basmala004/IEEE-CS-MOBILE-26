  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: AnimatedNotchBottomBar(
          ...
          // PS: this code is not like the video , and it might look somehow advanced so you might think i used ai , but it's not true, in fact , android studio it self suggested them to me so i went with them
          onTap: (value) {
...
BottomBarItem bottomBarItem({
  ...
  required String itemLabel
    ...
    itemLabelWidget: Text(itemLabel, style: const TextStyle(color: Colors.lightBlueAccent),)
);